# Orders of deparment of Minorities Development Department Government of Maharashtra

This is a data package repository that process orders obtained from department of Minorities Development Department Government of Maharasthra. The data is obtained by processing orders from Government of Maharashtra's [Orders Website](https://gr.maharashtra.gov.in/1145/Government-Resolutions) website.
...
1. [mahmin-*.pdf.en.txt](flow/writeTxt_/output/): Orders in Marathi.

2. [mahmin-*.pdf.mr.txt](flow/writeTxt_/output/): Orders in English.
...
## Data Details
- **First Order:** [201803091218355314.pdf](https://gr.maharashtra.gov.in/Site/Upload/Government%20Resolutions/English/201803091218355314.pdf) (09 March 2018)
- **Last Order:** [202309051252074414.pdf](https://gr.maharashtra.gov.in/Site/Upload/Government%20Resolutions/English/202309051252074414.pdf) (05 September 2023)
- **Last Crawl Date:** 11-Sep-2023
- **Total Orders:** 809
- **Translated Orders:** 804
...
```
git clone https://github.com/orgpedia/mahmin.git
```
