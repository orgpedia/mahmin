...
import/websites/gr.maharashtra.gov.in/Minorities:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/Minorities .
...
import: check_env import/websites/gr.maharashtra.gov.in/Minorities .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/Minorities import/documents
